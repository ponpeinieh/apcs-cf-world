...
execute @s[scores={planet=0}] ~ ~ ~ function act/1/reset_0
execute @s[scores={planet=1}] ~ ~ ~ function act/1/reset_1
execute @s[scores={planet=2}] ~ ~ ~ function act/1/reset_2
execute @s[scores={planet=3}] ~ ~ ~ function act/1/reset_3
