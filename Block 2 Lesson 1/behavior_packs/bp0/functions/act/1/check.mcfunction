...
#> POSITIONAL GOAL
execute @a[scores={makecode=-2}] ~ ~ ~ detect 51 80 61 air 0 execute @c[x=52,y=80,z=61,dx=0,dy=0,dz=0] ~ ~ ~ scoreboard players add @e[tag=game] goal 1
...
execute @a ~ ~ ~ teleport @c[tag=!moved] 52 80 58 90 0
