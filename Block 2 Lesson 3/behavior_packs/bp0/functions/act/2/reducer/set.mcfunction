...
execute @a ~ ~ ~ replaceitem entity @c slot.inventory 0 stone 6 0
#swap npcs
...
#set signs
clone 26 148 54 26 148 54 26 150 54
clone 26 148 54 26 148 54 26 150 2054
clone 26 148 54 26 148 54 26 150 4054
