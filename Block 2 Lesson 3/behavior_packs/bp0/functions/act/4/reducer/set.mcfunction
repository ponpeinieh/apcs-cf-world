...
execute @a ~ ~ ~ replaceitem entity @c slot.inventory 0 red_sandstone 1 3
#swap npcs
...
#set signs
clone 25 148 54 25 148 54 25 150 54
clone 25 148 54 25 148 54 25 150 2054
clone 25 148 54 25 148 54 25 150 4054
